  ...
  return (
    <Card className="overflow-hidden pb-6">
      <CardHeader className="bg-bark-primary text-white p-6">
        ...
        <p className="text-sm text-bark-secondary mt-2">IBCM tokens can be purchased using the following cryptocurrencies. Prices are updated in real-time.</p>
      </CardHeader>
              ...
              <div className="flex-grow">
                ...
                {loading ? (
                  ...
                  <p className="text-xs text-gray-600 mt-1">
                    1 IBCM = <span className="font-medium text-bark-accent">{getBARKPrice(currency.name, prices).toFixed(6)} {currency.name}</span>
                  </p>
                ) : (
