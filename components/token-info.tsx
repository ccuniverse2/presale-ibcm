  ...
  return (
    <Card className="shadow-smooth hover:shadow-md transition-all duration-300 bg-card overflow-hidden">
      <CardHeader className="pb-4 pt-8 bg-white">
        <CardTitle className="text-3xl font-bold text-center text-gray-950">IBCM Token Information</CardTitle>
      </CardHeader>
      <CardContent className="space-y-8 text-card-foreground pb-8 pt-6">
        <p className="text-xl text-center text-gray-700 mb-6 max-w-2xl mx-auto">
          IBCM is the native token of the IBCM Protocol, powering transactions and governance within our ecosystem.
        </p>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <InfoItem icon={Coins} title="Max Supply" value="18,446,744,073 IBCM" />
          <InfoItem icon={Users} title="Initial Circulating Supply" value="1,000,000,000 IBCM" />
