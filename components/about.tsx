...
export function AboutContent() {
  return (
    <>
      <Card className="mb-8">
        <CardHeader>
          <CardTitle className="text-3xl font-bold text-center">About IBCM Token</CardTitle>
        </CardHeader>
        <CardContent className="prose max-w-none">
          <p>
            IBCM Token is a revolutionary cryptocurrency built on the Solana blockchain, designed to power the future of decentralized pet care and animal welfare initiatives.
          </p>
      ...
      <Card>
        ...
        <CardContent className="prose max-w-none">
          <p>
            The IBCM Token project is led by a team of passionate individuals with diverse backgrounds in blockchain technology, animal welfare, and business development.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
            <div>
              ...
              <p className="mt-2">
                With over 10 years of experience in animal welfare and 5 years in blockchain, Jane leads the vision and strategy for IBCM Token.
              </p>
            </div>
            <div>
              ...
              <p className="mt-2">
                A veteran software engineer with expertise in Solana and Ethereum, John oversees the technical development of the IBCM Token ecosystem.
              </p>
            </div>
            <div>
              ...
              <p className="mt-2">
                Emily brings her extensive network in the pet care industry to forge strategic partnerships and drive adoption of IBCM Token.
              </p>
            </div>
            <div>
