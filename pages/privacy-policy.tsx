      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        <Card>
          ...
          <CardContent className="prose max-w-none">
            ...
            <p>We collect personal information that you provide to us when participating in the IBCM Token sale.</p>
            ...
            <h2>8. Contact Us</h2>
            <p>If you have any questions about this privacy policy, please contact us at privacy@IBCMprotocol.com.</p>
          </CardContent>
        </Card>
      </main>
      <Footer />
