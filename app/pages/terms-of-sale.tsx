          ...
          <CardContent className="p-8">
            <div className="space-y-6">
              <Section title="1. Acceptance of Terms">
                By participating in the IBCM Token sale, you agree to be bound by these Terms of Sale.
              </Section>
              ...
              <Section title="3. Token Purchase">
                IBCM Tokens are sold on a first-come, first-served basis. The purchase is final and non-refundable.
              </Section>

              <Section title="4. Risks">
                Purchasing IBCM Tokens involves significant risk. You acknowledge and assume all risks associated with digital assets and blockchain technology.
              </Section>
              ...
              <Section title="6. Disclaimers">
                IBCM Protocol provides no guarantees regarding the future value or utility of IBCM Tokens.
              </Section>
